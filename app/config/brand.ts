...
export const SUPPORT_EMAIL = "support@skuforge.app";

/** Legal entity named as the data controller in the privacy policy. */
export const LEGAL_ENTITY = "SKUForge";
...
/** How long job/scan history is kept for an installed shop. */
export const DATA_RETENTION_SUMMARY =
  "for as long as the app is installed, and deleted when you uninstall or request erasure";
